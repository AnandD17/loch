...
const Check = (props: InterfaceSVG) => {
  return (
    <svg onClick={props.onClick} className="cursor-pointer"
    width={props.width||"15"} height={props.height||"14"} viewBox={`0 0 ${props.width||15} ${props.height||14}`} fill={props.fill||"none"}
