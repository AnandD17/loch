...
const BellSpaced = (props: InterfaceSVG) => {
  return (
    <svg width={props.width||"28"} height={props.height||"28"} viewBox={`0 0 ${props.width||28} ${props.height||28}`} fill={props.fill||"none"} xmlns="http://www.w3.org/2000/svg">
